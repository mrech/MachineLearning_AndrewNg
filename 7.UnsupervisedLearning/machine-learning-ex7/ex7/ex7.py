...
#  each example. After that, we recontruct the image replacing each pixel
# location with the mean of the centroid assigned to it. 
...
X_recovered = centroids[idx.astype(int).flatten(),:]
